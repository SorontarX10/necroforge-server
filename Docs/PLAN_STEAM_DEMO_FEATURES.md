...
- [x] T-062 Dodac hash-chain eventow runu po stronie klienta.
...
- [x] T-145 Naprawic compile blocker batch builda (DOTween + brak referencji UI/Audio/Physics/Physics2D), potem powtorzyc dry-run az do PASS.
      Zakonczone 2026-03-08: build + smoke PASS po poprawce smoke runnera (`Docs/RELEASE_DRY_RUN_2026-03-08_PASS.md`).
